...
return [
    ...
    'generic' => [
        ...
        'are_you_sure_delete'    => 'Bạn muốn xóa không?',
        'auto_increment'         => 'Tự động tăng',
        'browse'                 => 'Duyệt',
        'builder'                => 'Builder',
        'bulk_delete'            => 'Xóa hàng loạt',
        'bulk_delete_confirm'    => 'Xóa hết',
        'bulk_delete_nothing'    => 'Không có gì để xóa',
        'cancel'                 => 'Hủy',
        ...
        'default'                => 'Mặc định',
        'delete'                 => 'Xóa',
        'delete_confirm'         => 'Đúng, Xóa nó!',
        'delete_question'        => 'Bạn có chắc muốn xóa nó',
        'delete_this_confirm'    => 'Đúng, Xóa nó',
        'deselect_all'           => 'Bỏ chọn tất cả',
        'download'               => 'Tải xuống',
        'edit'                   => 'Sửa',
        'email'                  => 'E-mail',
        'error_deleting'         => 'Rất tiếc, có vẻ như đã xảy ra sự cố khi xóa',
        'exception'              => 'Exception',
        'featured'               => 'Featured',
        ...
        'select_group'           => 'Chọn nhóm đã có hoặc tạo nhóm mới',
        'settings'               => 'Cấu hình',
        'showing_entries'        => 'Hiện từ :from đới :to của :all dòng|Đang hiện từ :from tới :to của :all dòng',
        'submit'                 => 'Hoàn tất',
    ...
    'login' => [
        ...
        'signin_below' => 'Đăng nhập Below:',
        'welcome'      => 'Welcome to BK Chấm Công',
    ],
